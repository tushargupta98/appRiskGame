...
/**
 * This class is for Benevolent player which implements player strategy
 * 
 * @author chowdhuryfarsadaurangzeb
 *
 */
public class BenevolentPlayer implements PlayerStrategy, GameInterface {
  ...
  private String name = "Benevolent Player";
  ...
  /**
   * Actual constructor method for benevolent player
   * 
   * @param noOfArmy
   */
  public BenevolentPlayer(int noOfArmy) {
  ...
  public void attack() {
    ...
    System.out.println(getName() + " decides not to attack.");
  }
  ...
  public void fortify() {
    ...
    // Find a country with lowest soldier and is able to attack
  ...
  public void reinforcement() {
    ...
    if (getListOfPlayersConqueredCountries() != null
      ...
      // Looks for Country with lowest number of Soldier
      Country countryWithLowestSoldier = getListOfPlayersConqueredCountries().get(0);
      for (int i = 1; i < getListOfPlayersConqueredCountries().size(); i++) {
        if (countryWithLowestSoldier.getSoilders() > getListOfPlayersConqueredCountries().get(i)
            .getSoilders()) {
          countryWithLowestSoldier = getListOfPlayersConqueredCountries().get(i);
        }
      }
      // Add all the unassigned soldier to that country.
      System.out.println(getName() + " reinforces " + getNoOfUnitUnassigned() + " army.");
      countryWithLowestSoldier.moveInSoldier(getNoOfUnitUnassigned());
